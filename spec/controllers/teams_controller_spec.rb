...
RSpec.describe TeamsController, type: :controller do
  ...
  let(:team_params) do
    { team: FactoryGirl.attributes_for(:team, name: 'NewTeamName', product: 'TeamProduct', region: 'TeamRegion', description: 'TeamDescription') }
  end
  ...
  describe "POST 'create'" do
    ...
    it 'creates a team' do
      ...
      expect(assigns(:team).name).to eq('NewTeamName')
  ...
  describe "PUT 'update'" do
    ...
    it 'should update a team' do
      put 'update', team_params.merge(id: team.id)
      expect(team.reload.name).to eq('NewTeamName')
